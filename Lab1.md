...
## 1. Создание проекта
   ...
   <img width="500" height="100" alt="image" src="https://github.com/user-attachments/assets/e2d880af-0739-475a-972b-2fb2b1523645" />
   ...
   - Диск: 20 ГБ HDD
   <img width="400" height="400" alt="image" src="https://github.com/user-attachments/assets/578453bd-e7b8-44b1-882a-3d92f687f3cb" />
   <img width="400" height="400" alt="image" src="https://github.com/user-attachments/assets/ed1413bd-8248-44ae-9eba-89e9acf05a57" />
   <img width="400" height="400" alt="image" src="https://github.com/user-attachments/assets/84a44048-a385-4fef-8f1e-c3b133b5aba2" />

   Получаем активную ВМ:
   
   <img width="600" height="200" alt="image" src="https://github.com/user-attachments/assets/8c51c57b-85b0-4a88-b62f-fd3fe8f95290" />
...
## 3. Установка PostgreSQL
   ...
   <img width="400" height="100" alt="image" src="https://github.com/user-attachments/assets/c21e517f-be36-4a13-84b4-301f1545c6ec" />
   <img width="600" height="200" alt="image" src="https://github.com/user-attachments/assets/df7579c1-8ef5-42e0-b5fc-45f622025660" />
...
## 5. Работа с транзакциями
   ...
   <img width="600" height="200" alt="image" src="https://github.com/user-attachments/assets/beb66238-d07d-4778-8264-31ff62c06d53" />

   Проверим созданную таблицу: select * from shipments;
...
## 6. Изучение уровней изоляции
   ...
   <img width="600" height="200" alt="image" src="https://github.com/user-attachments/assets/bb619a66-f338-48a7-a84c-cf03f5141e98" />

   2 сессия:
   Изменений нет, новая строка не добавилась
   
   <img width="300" height="200" alt="image" src="https://github.com/user-attachments/assets/3a9b552b-516c-4586-a91b-013e5f7d7418" />
...
## 7. Эксперименты с уровнем изоляции Repeatable Read
   ...
   <img width="800" height="200" alt="image" src="https://github.com/user-attachments/assets/cef0d271-2334-4bbd-938d-03a9198ef77a" />
